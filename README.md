...
- ✅ LiveKit-compatible port configuration
...
**📌 Note:** Prometheus uses port **9091** (not the standard 9090) to avoid conflicts with LiveKit Ingress, which uses port 9090. This is configured by default in the toolkit.
